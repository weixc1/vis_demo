		...
		function zhexian(params) {
			$.ajax({
				...
				success: function(data) {
					...
					let SO2 = [20.08, 18.77, 11.98, 58.48, 42.4, 32.8, 23.57, 5.89, 19.91, 6.88, 4.97, 2.35]
					let CO = [45, 120, 23.17, 150.94, 12.66, 90.4, 13.69, 24.84, 65.36, 32.69, 120.52, 23.38]
					let PM2_5 = [32.13, 31, 25.05, 51.51, 43.88, 45.5, 34.41, 100.31, 38.78, 17.53, 15.09, 7.44]
					let PM10 = [61.32, 61.82, 150.75, 102.53, 93.16, 94.29, 66.49, 39.84, 79.57, 32.75, 26.18, 11.16]
					let NO2 = [20.08, 18.77, 100.98, 58.48, 42.4, 32.8, 150.57, 5.89, 19.91, 165.88, 4.97, 2.35]
					let O3 = [49.23, 52.02, 59.86, 26.37, 130.06, 45.81, 55.9, 59.54, 132.51, 63.6, 67.42, 72.4]
